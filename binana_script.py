...
# calculates all possible binana interactions for the set of complexes and then calculates the counts of those interactions for all complexes

import sys  
sys.path.append('/localdisk/home/s2173344/Research_Project/binana/python')
import binana
import pandas as pd
import os
...
print("Finding possible interaction types")
...
for complex in complex_list:
    ...
    rec_file = complex + "_protein_H.pdbqt"
    print(complex)
...
print("Doing the interaction counts")
for complex in complex_list:
    os.chdir(complex)
    print(complex)
    count_row = []
    ...
    for interaction in uniq_headers[1:]:
        if interaction_dict.get(interaction):
